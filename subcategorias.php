<?php
    require_once realpath(dirname(__FILE__).'/src/models/SubcategoriasModel.php'); 
?>
<!DOCTYPE html>
<!--
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Subcategoria de eventos</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div>
                                    ...
                                    <table id="tabelaCategorias" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Categoria</th>
                                                <th>Subcategoria</th>
                                                <th style="width: 130px">Nome</th>Ações</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
                                            ...
                                            $listaSubcategorias = SubcategoriasModel::listarTodos();
